...
class TwitterCrowdsSpecificMethodsTests(unittest.TestCase):
    ...
    def test_getMessageObjectForTweet(self):
        message = TwitterCrowdsSpecificMethods.getMessageObjectForTweet(self.tweet, self.phraseToIdMap, self.max_dimensions, self.min_phrase_length, self.max_phrase_length)
