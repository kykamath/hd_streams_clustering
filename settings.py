...
twitter_stream_settings = Settings(
                                   max_dimensions=500, # Number of maximum dimensions to consider at a time. This is also equal to the number of top phrases that will be considered for crowd discovery.
