...
twitter_stream_settings = Settings(
                                   ...
                                   max_phrase_length=2, # Mzximum lenght of phrases. For example min_phrase_length=1 and max_phrase_length=2 will result in both unigrams and bigrams as features.
