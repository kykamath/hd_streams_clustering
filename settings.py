...
default_experts_twitter_stream_settings.dimension_update_frequency_in_seconds=time_unit_in_seconds*36
default_experts_twitter_stream_settings.max_phrase_inactivity_time_in_seconds=time_unit_in_seconds*107
default_experts_twitter_stream_settings.cluster_filter_threshold = 2
default_experts_twitter_stream_settings.cluster_inactivity_time_in_seconds=time_unit_in_seconds*2
